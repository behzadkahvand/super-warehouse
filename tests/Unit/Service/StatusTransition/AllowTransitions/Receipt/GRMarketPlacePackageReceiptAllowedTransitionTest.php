...
class GRMarketPlacePackageReceiptAllowedTransitionTest extends MockeryTestCase
{
    private GRMarketPlacePackageReceiptAllowedTransition|null $receiptAllowedTransition;

    protected function setUp(): void
    {
        parent::setUp();
        $this->receiptAllowedTransition = new GRMarketPlacePackageReceiptAllowedTransition();
    }
