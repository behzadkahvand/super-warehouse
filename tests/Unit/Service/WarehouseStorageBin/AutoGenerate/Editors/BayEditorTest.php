...
final class BayEditorTest extends MockeryTestCase
{
    ...
    public function testItSupports(): void
    {
        ...
        self::assertTrue($bayEditor->supports($this->autoGenerateData));
    }
    ...
    public function testItDoesNotSupports(): void
    {
        ...
        self::assertFalse($bayEditor->supports($this->autoGenerateData));
    }

    public function testItCanEdit(): void
    {
        $baySerials = ['AA-A1', 'AA-A2'];
        ...
        self::assertCount(2, $bayEditor->edit($this->autoGenerateData));
    }
}
