...
final class CellCreatorTest extends MockeryTestCase
{
    ...
    public function testItSupports(): void
    {
        ...
        self::assertTrue($cellCreator->supports($this->autoGenerateData));
    }
    ...
    public function testItDoesNotSupport(): void
    {
        ...
        self::assertFalse($cellCreator->supports($this->autoGenerateData));
    }
    ...
    public function testPriority(): void
    {
        ...
        self::assertEquals(1, $cellCreator->getPriority());
    }
    ...
    public function testCreate(): void
    {
        ...
        $unitOfWork->shouldReceive('getScheduledEntityInsertions')
                   ->twice()
                   ->withNoArgs()
                   ->andReturn([(new WarehouseStorageBin())->setSerial('W1A1-AA-A0')]);
        ...
        $result = $cellCreator->create($this->autoGenerateData);
