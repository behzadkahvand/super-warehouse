...
use App\Service\MongoFilter\Filters\Integration\EventStore\MessageIdFilter;
use App\Tests\Unit\BaseUnitTestCase;
use Doctrine\ODM\MongoDB\Query\Builder;
use Mockery;

final class MessageIdFilterTest extends BaseUnitTestCase
{
    ...
    {
        self::assertEquals(100, MessageIdFilter::getPriority());
    }
}
