...
use App\Service\MongoFilter\Filters\Integration\LogStore\ResultMessageFilter;
use App\Tests\Unit\BaseUnitTestCase;
use Doctrine\ODM\MongoDB\Query\Builder;
use Mockery;

final class ResultMessageFilterTest extends BaseUnitTestCase
{
    ...
    {
        self::assertEquals(80, ResultMessageFilter::getPriority());
    }
}
