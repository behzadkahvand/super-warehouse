...
use App\Service\MongoFilter\Filters\Integration\LogStore\MinCreatedAtFilter;
...
final class MinCreatedAtFilterTest extends BaseUnitTestCase
{
    ...
    public function testDoInvoke(): void
    {
        ...
        $requestData = ['filter' => ['log_store.createdAt.min' => '2022-12-10 23:59:59']];
    ...
    {
        self::assertEquals(60, MinCreatedAtFilter::getPriority());
    }
}
