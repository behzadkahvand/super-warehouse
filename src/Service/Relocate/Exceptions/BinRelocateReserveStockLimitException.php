...
class BinRelocateReserveStockLimitException extends Exception implements
    RenderableThrowableInterface,
    ReportableThrowableInterface
{
    protected $code = Response::HTTP_BAD_REQUEST;

    protected $message = "You can't relocate this storageBin because this storageBin has reserved stock!";
