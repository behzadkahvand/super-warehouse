...
class MessageNameFilter extends AbstractPipelineFilter implements TagAwarePipelineStageInterface
{
    protected function doInvoke(FilterPayload $payload): FilterPayload
    {
        return $payload->setQueryBuilder(
            $payload->getQueryBuilder()->field('message_name')
                ->equals(new Regex((string)$payload->getRequestFilters()['filter'][$this->filterName()]))
        );
    }

    protected function filterName(): string
    {
        return "event_store.messageName";
    }
