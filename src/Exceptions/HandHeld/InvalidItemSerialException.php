...
namespace App\Exceptions\HandHeld;
...
class InvalidItemSerialException extends Exception implements RenderableThrowableInterface, ReportableThrowableInterface
{
